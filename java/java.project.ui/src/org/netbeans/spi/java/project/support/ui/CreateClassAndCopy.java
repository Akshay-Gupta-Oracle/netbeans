...
public final class CreateClassAndCopy implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ev) {
        try {
            ...
            String className = "";
            String uncommented = data.replaceAll("(?:/\\*(?:[^*]|(?:\\*+[^*/]))*\\*+/)|(?://.*)","");
            uncommented = uncommented.trim();
            StringTokenizer st = new StringTokenizer(uncommented, " ");
            if (st.hasMoreTokens() && st.nextToken().equals("public") && st.hasMoreTokens() && st.nextToken().equals("class") && st.hasMoreTokens()) {
            ...
            while (!selectedNode.getName().equals("${src.dir}")) {
